...
RDA\Debug\RDAL_Client.exe -file scans\sector\D-1.txt -reduce_median_window 11 -max_dist_diff 100 -min_segm_points 10 -min_rdp_eps 5 -min_rdp_size 10 -statistacal_kN 5 -statistacal_threashold 1.0
