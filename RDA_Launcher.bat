...
RDA\Debug\RDA.exe -raw_file scans\R-1.txt -error_file scans\dist_error_measurements\standart_deviations.txt -rdp_error 3 -filter_window 10 -filter_error 1 -min_segm_points 5 -breakpoint_error 4
