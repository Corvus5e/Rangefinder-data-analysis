...
RDA\Debug\RDA.exe -raw_file scans\sector\D-35.txt -error_file scans\dist_error_measurements\standart_deviations.txt -rdp_error 3 -filter_window 5 -filter_error 1
